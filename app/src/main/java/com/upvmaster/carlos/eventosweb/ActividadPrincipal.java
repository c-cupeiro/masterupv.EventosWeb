package com.upvmaster.carlos.eventosweb;
...
public class ActividadPrincipal extends AppCompatActivity {
    ...
    private Button btnDetener, btnAnterior, btnSiguiente, btnIr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse( "https://eventos-114fc.firebaseapp.com/index.html");
        intent.setData(uri);
        ...
        navegador.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                dialogo.dismiss();
                btnDetener.setEnabled(false);
                txtDireccion.setText(navegador.getUrl());
                if (view.canGoBack()) {
    ...
    public void irDireccion(View v) {
        String url = txtDireccion.getText().toString();
        if (!url.contains("http://") && !url.contains("https://")) {
            url = "http://" + url;
        }
        txtDireccion.setText(url);
